        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 id="hero-title" className="text-4xl md:text-6xl font-extrabold text-slate-900 leading-tight mb-6 font-display">
              Os melhores Aquecedores e Serviço de Gasista para o <span className="text-orange-500">Conforto e Segurança</span> para sua Família
            </h1>
            
            <p className="text-lg text-slate-600 mb-8 max-w-lg">
              Oferecemos serviços profissionais de instalação e manutenção de aquecedores das melhores marcas, além de soluções completas em redes de gás. 
              Unimos técnica especializada e agilidade para garantir o máximo de conforto, economia e segurança para sua família, com o atendimento referência em São Paulo.
            </p>
          ...
          >
             ...
             <div className="relative z-10 bg-white p-3 rounded-[2.5rem] shadow-2xl border border-slate-100 rotate-2 hover:rotate-0 transition-transform duration-500">
               <div className="relative rounded-[2rem] w-full h-[350px] overflow-hidden bg-slate-100">
                 ...
                 />
                 <img
                   src={gasistaServicoImg}
                   alt="Gasista Serviço"
                   className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ${currentImageIndex === 3 ? "opacity-100" : "opacity-0"}`}
                 />
              </div>
